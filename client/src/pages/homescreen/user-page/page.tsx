...
const UserPage: React.FC = () => {
    ...
    return (
        <div className="w-screen h-full pb-4 flex justify-center px-8 py-4 md:px-24 md:py-8 lg:px-36 lg:py-8">
            <div className="h-full max-w-[1024px] w-full flex flex-col gap-8 md:gap-12 lg:gap-10">
                ...
                {userItineraries.length === 0 && (
                    <div className="w-full h-full flex justify-center items-center">
                        <p className="scroll-m-20 text-3xl font-regular tracking-tight translate-y-[-80px]">
